...
//////////////////////////////////////////////////////
	...
	//Just a safety thing, not supported on every device
		...
		#if defined(_MK_RIM_DEFAULT) && defined(MK_FORWARD_BASE_PASS)
	...
	*/
	...
	/////////////////////////////////////////////////////////////////////////////////////////////
	#if defined(MK_VERTEX_ANIMATION_MAP) || defined(MK_THRESHOLD_MAP) || defined(MK_PARTICLES) || defined(MK_ALBEDO_MAP) || defined(MK_DISSOLVE) || defined(MK_GOOCH_MAP) || defined(MK_LightTransmission) || defined(MK_NORMAL_MAP) || defined(MK_DETAIL_NORMAL_MAP) || defined(MK_EMISSION_MAP) || defined(MK_OCCLUSION_MAP) || defined(MK_ARTISTIC_HATCHING) || defined(MK_ARTISTIC_DRAWN) || defined(MK_ARTISTIC_SKETCH) || defined(MK_REFRACTION_DISTORTION_MAP)
		#ifndef MK_TCM
			#define MK_TCM
		#endif
	#endif
	...
	#if defined(MK_ARTISTIC) && defined(MK_ARTISTIC_PROJECTION_SCREEN_SPACE) || defined(MK_REFRACTION) || defined(MK_SOFT_FADE) || defined(MK_CAMERA_FADE)
		#ifndef MK_POS_CLIP
			#define MK_POS_CLIP
		#endif
	#endif
