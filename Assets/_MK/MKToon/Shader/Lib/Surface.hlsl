...
//////////////////////////////////////////////////////
	...
	struct SurfaceData
	{
		...
		#if defined(MK_VERTCLR) || defined(MK_PARTICLES)
			autoLP4 vertexColor;
		#endif
	...
	// Initialize
	/////////////////////////////////////////////////////////////////////////////////////////////
	inline SurfaceData ComputeSurfaceData
	(
		//#ifdef MK_POS_WORLD
	...
	)
	{
		...
		INITIALIZE_STRUCT(SurfaceData, surfaceData);
		...
		#ifdef MK_DISSOLVE
			surfaceData.dissolveClip = SAMPLE_TEX2D_FLIPBOOK(_DissolveMap, SAMPLER_REPEAT_MAIN, surfaceData.baseUV.xy * _DissolveMapScale, SURFACE_FLIPBOOK_UV).r - _DissolveAmount;
	...
	inline MKPBSData ComputePBSData(inout Surface surface, in SurfaceData surfaceData)
	{
		MKPBSData pbsData;
	...
	inline Surface InitSurface(in SurfaceData surfaceData, DECLARE_TEXTURE_2D_ARGS(albedoMap, samplerTex), inout half4 albedoTint)
	{
		//Init Surface
		Surface surface;
		...
		//add detail
			...
			surface.goochDark = _GoochDarkColor;
				...
				surface.rimBright = surface.rimDark = 0;
			#elif defined(MK_RIM_DEFAULT)
				surface.rim = 0;
			#endif
